package org.naman.quorabackend.config;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:quora-group}")
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "org.naman.quorabackend.events");
